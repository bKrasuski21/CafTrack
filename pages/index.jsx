    ...
    return (
      <>
        ...
        <DateTimeDisplay/>
         ...
         <select className = "appSelect" value={time} onChange={(e) => setTime(e.target.value)}>
           <option value="">Select Time</option>
           {availableTimes.map((timeOption, index) => (
             <option key={index} value={timeOption}>{timeOption}</option>
           ))}
         </select>
         <select className = "appSelect" value={AMPM} onChange={(e) => setAMPM(e.target.value)}>
           <option value="">Select AM/PM</option>
           {availableAM.map((timeOption, index) => (
             <option key={index} value={timeOption}>{timeOption}</option>
           ))}
         </select>
         <select className = "appSelect" value={dayOfWeek} onChange={(e) => setDayOfWeek(e.target.value)}>
         ...
         />
         <Button className="btn-custom" onClick={() => {handleSubmit()}}>Add to Chart</Button>
         <Button className="btn-custom" onClick={() => {AddCaffeineToCurrentTime()}}>Add Caffeine To Current Time</Button>
       </div>
       <div className="chart-container">
       <LineChart className = "appLineChart"
         width={1800}
         height={400}
         data={chartData}
         margin={{
       ...
       <div className = "appButtons">
         <Button className="btn-custom" onClick={() => {Monday()}}>Monday</Button>
         <Button className="btn-custom" onClick={() => {Tuesday()}}>Tuesday</Button>
         <Button className="btn-custom" onClick={() => {Wednesday()}}>Wednesday</Button>
         <Button className="btn-custom" onClick={() => {Thursday()}}>Thursday</Button>
         <Button className="btn-custom" onClick={() => {Friday()}}>Friday</Button>
         <Button className="btn-custom" onClick={() => {Saturday()}}>Saturday</Button>
         <Button className="btn-custom" onClick={() => {Sunday()}}>Sunday</Button>
         <Button className="btn-custom" onClick={() => {clearData()}}>Clear Graph</Button>
       </div>
